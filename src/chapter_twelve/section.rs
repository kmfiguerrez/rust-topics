use crate::{chapter::Section, chapter_twelve::{twelve_point_five, twelve_point_four, twelve_point_one, twelve_point_six, twelve_point_three, twelve_point_two}};
...
pub fn generate_sections() -> Vec<Section<'static>> {
  vec![
    ...
    Section::new("Redirecting Errors to Standard Error", "Section 12.6", twelve_point_six::content),
  ]
}